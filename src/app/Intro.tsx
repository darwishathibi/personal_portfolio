    ...
    <div className="size-full max-w-lg items-center justify-center overflow-hidden pt-8">
      ...
      <BoxReveal boxColor={"#A4C24F"} duration={0.5}>
        <p className="text-5xl md:text-7xl lg:text-8xl font-semibold">
          Hi&#44; I&acute;m{" "}
          <span className="text-middle-green-yellow">Darwis.</span>
        </p>
      </BoxReveal>

      <BoxReveal boxColor={"#A4C24F"} duration={0.5}>
        <h2 className="mt-[.5rem] text-[1rem] md:text-2xl">
          A <span className="text-middle-green-yellow">Computer Science</span>{" "}
          student.
        </h2>
      </BoxReveal>
      ...
      <BoxReveal boxColor={"#A4C24F"} duration={0.5}>
        <div className="mt-6">
          <p className="text-base md:text-2xl">
            ...
            <span className="font-semibold text-middle-green-yellow">
              ship it.
            </span>{" "}
            If it doesn&acute;t…{" "}
            <span className="font-semibold text-middle-green-yellow">
